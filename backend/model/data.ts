...
var JaniatorList: Janiator[] = [
    ...
    new Janiator(20, Shift.Morning),
    new Janiator(21, Shift.Morning),
    new Janiator(22, Shift.Afternoon),
    new Janiator(23, Shift.Evening),
    new Janiator(24, Shift.Morning),
    new Janiator(25, Shift.Afternoon),
    new Janiator(26, Shift.Evening),
    new Janiator(27, Shift.Morning),
    new Janiator(28, Shift.Afternoon),
    new Janiator(29, Shift.Evening),
    new Janiator(30, Shift.Morning),
    new Janiator(31, Shift.Morning),
    new Janiator(32, Shift.Afternoon),
    new Janiator(33, Shift.Evening),
    new Janiator(34, Shift.Morning),
    new Janiator(35, Shift.Afternoon),
    new Janiator(36, Shift.Evening),
    new Janiator(37, Shift.Morning),
    new Janiator(38, Shift.Afternoon),
    new Janiator(39, Shift.Evening),
]
